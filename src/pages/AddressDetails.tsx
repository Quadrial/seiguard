    ...
    return (
      <div className="mt-10 px-10 text-white font-sans">
        <div className="max-w-4xl mx-auto text-center py-20">
          <h2 className="text-2xl font-semibold mb-2">EVM Address</h2>
          <div className="font-mono text-sm mb-4">{address}</div>
          <p className="text-gray-400 mb-6">No matching Sei account found for this EVM address.</p>
